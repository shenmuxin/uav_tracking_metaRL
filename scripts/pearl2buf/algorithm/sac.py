...
from pearl.algorithm.networks import FlattenMLP, MLPEncoder, TanhGaussianPolicy
...
class SAC:
    ...
    def train_model(
        ...
        params:
            `context_batch` shape is (meta_batch_size, batch_size, s+a+r)
            `transition_batch` is defined as [{s, a, r, s', d}...] in rl manner
